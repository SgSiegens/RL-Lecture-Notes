...
game where the state is defined by underlying game mechanics. Since most of the time you don't actually have access to 
these things you might only infer information about the world through the current frame (this is the observation).\newline 
The reward indicates how good or bad the agent’s last action was, providing feedback 
