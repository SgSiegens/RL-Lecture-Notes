...
\definecolor{citeblue}{RGB}{0,0,180}

% Setup hyperref with colored boxes
\hypersetup{
    colorlinks=true,         % false = boxed links; true = colored text
    linkcolor=darkred,       % color for cross-references (equations, figures, sections)
    citecolor=citeblue,      % color for citations
    urlcolor=blue,           % color for URLs
    linkbordercolor=darkred, % if you want boxes instead of colored text, set color here
    pdfborderstyle={/S/U/W 1} % optional: underline style for links
}
...
(KIT). I began writing them to deepen my own understanding of the material. The structure of the notes reflects my personal learning process and what made the most sense to me.
